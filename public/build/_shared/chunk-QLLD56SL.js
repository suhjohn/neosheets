  ...
  "node_modules/.pnpm/localforage@1.10.0/node_modules/localforage/dist/localforage.js"(exports, module) {
    (function(f) {
      ...
      return function e(t, n, r) {
        ...
        function callWhenReady(localForageInstance2, libraryMethod) {
          localForageInstance2[libraryMethod] = function() {
            var _args = arguments;
            return localForageInstance2.ready().then(function() {
              return localForageInstance2[libraryMethod].apply(localForageInstance2, _args);
            });
          };
        }
        function extend() {
...
// node_modules/.pnpm/remix-utils@7.6.0_@remix-run+cloudflare@2.12.1_@cloudflare+workers-types@4.20241004.0_typescr_mjcnq77pcyb37n5v5jlata5tyu/node_modules/remix-utils/build/react/client-only.js
var React = __toESM(require_react(), 1);

// node_modules/.pnpm/remix-utils@7.6.0_@remix-run+cloudflare@2.12.1_@cloudflare+workers-types@4.20241004.0_typescr_mjcnq77pcyb37n5v5jlata5tyu/node_modules/remix-utils/build/react/use-hydrated.js
...
var DialogPortal = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React21.Children.map(children, (child) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
var DrawerContext = import_react3.default.createContext({
  drawerRef: {
    current: null
  },
  overlayRef: {
...
var useDrawerContext = () => {
  const context = import_react3.default.useContext(DrawerContext);
  if (!context) {
...
function usePositionFixed({ isOpen, modal, nested, hasBeenOpened, preventScrollRestoration, noBodyStyles }) {
  const [activeUrl, setActiveUrl] = import_react3.default.useState(() => typeof window !== "undefined" ? window.location.href : "");
  const scrollPos = import_react3.default.useRef(0);
  const setPositionFixed = import_react3.default.useCallback(
    () => {
  ...
  const restorePositionSetting = import_react3.default.useCallback(
    () => {
...
function useCallbackRef3(callback) {
  const callbackRef = import_react3.default.useRef(callback);
  import_react3.default.useEffect(() => {
    callbackRef.current = callback;
  });
  return import_react3.default.useMemo(() => (...args) => callbackRef.current == null ? void 0 : callbackRef.current.call(callbackRef, ...args), []);
}
function useUncontrolledState2({ defaultProp, onChange }) {
  const uncontrolledState = import_react3.default.useState(defaultProp);
  const [value] = uncontrolledState;
...
function useControllableState2({ prop, defaultProp, onChange = () => {
  ...
  const value = isControlled ? prop : uncontrolledProp;
  const handleChange = useCallbackRef3(onChange);
  const setValue = import_react3.default.useCallback(
    (nextValue) => {
      if (isControlled) {
        const setter = nextValue;
        const value2 = typeof nextValue === "function" ? setter(prop) : nextValue;
...
function useSnapPoints({ activeSnapPointProp, setActiveSnapPointProp, snapPoints, drawerRef, overlayRef, fadeFromIndex, onSnapPointChange, direction = "bottom" }) {
  ...
  const isLastSnapPoint = import_react3.default.useMemo(
  ...
  const activeSnapPointIndex = import_react3.default.useMemo(
    () => snapPoints == null ? void 0 : snapPoints.findIndex((snapPoint) => snapPoint === activeSnapPoint),
    [
      snapPoints,
      activeSnapPoint
    ]
  );
  const snapPointsOffset = import_react3.default.useMemo(
    () => {
      var _snapPoints_map;
  ...
  const activeSnapPointOffset = import_react3.default.useMemo(
  ...
  const snapToPoint = import_react3.default.useCallback(
    (dimension) => {
...
function Root2({ open: openProp, onOpenChange, children, shouldScaleBackground, onDrag: onDragProp, onRelease: onReleaseProp, snapPoints, nested = false, setBackgroundColorOnScale = true, closeThreshold = CLOSE_THRESHOLD, scrollLockTimeout = SCROLL_LOCK_TIMEOUT, dismissible = true, handleOnly = false, fadeFromIndex = snapPoints && snapPoints.length - 1, activeSnapPoint: activeSnapPointProp, setActiveSnapPoint: setActiveSnapPointProp, fixed, modal = true, onClose, noBodyStyles, direction = "bottom", preventScrollRestoration = true, disablePreventScroll = false }) {
  ...
  const [isOpen = false, setIsOpen] = import_react3.default.useState(false);
  const [hasBeenOpened, setHasBeenOpened] = import_react3.default.useState(false);
  ...
  const [justReleased, setJustReleased] = import_react3.default.useState(false);
  const overlayRef = import_react3.default.useRef(null);
  const openTime = import_react3.default.useRef(null);
  const dragStartTime = import_react3.default.useRef(null);
  const dragEndTime = import_react3.default.useRef(null);
  const lastTimeDragPrevented = import_react3.default.useRef(null);
  const isAllowedToDrag = import_react3.default.useRef(false);
  const nestedOpenChangeTimer = import_react3.default.useRef(null);
  const pointerStart = import_react3.default.useRef(0);
  const keyboardIsOpen = import_react3.default.useRef(false);
  const previousDiffFromInitial = import_react3.default.useRef(0);
  const drawerRef = import_react3.default.useRef(null);
  const drawerHeightRef = import_react3.default.useRef(((_drawerRef_current = drawerRef.current) == null ? void 0 : _drawerRef_current.getBoundingClientRect().height) || 0);
  const initialDrawerHeight = import_react3.default.useRef(0);
  const onSnapPointChange = import_react3.default.useCallback((activeSnapPointIndex2) => {
  ...
  return /* @__PURE__ */ import_react3.default.createElement(Root, {
    ...
    open: isOpen
  }, /* @__PURE__ */ import_react3.default.createElement(DrawerContext.Provider, {
    value: {
      visible,
      activeSnapPoint,
      snapPoints,
...
var Handle = /* @__PURE__ */ import_react3.default.forwardRef(function({ preventCycle = false, children, ...rest }, ref) {
  ...
  const closeTimeoutIdRef = import_react3.default.useRef(null);
  const shouldCancelInteractionRef = import_react3.default.useRef(false);
...
var Overlay2 = /* @__PURE__ */ import_react3.default.forwardRef(function({ children, ...rest }, ref) {
  ...
  return /* @__PURE__ */ import_react3.default.createElement(Overlay, {
    onMouseUp: onRelease,
    ref: composedRef,
    "vaul-drawer-visible": visible ? "true" : "false",
    "vaul-overlay": "",
...
var Content2 = /* @__PURE__ */ import_react3.default.forwardRef(function({ onOpenAutoFocus, onPointerDownOutside, onAnimationEnd, style, ...rest }, ref) {
  ...
  const pointerStartRef = import_react3.default.useRef(null);
  const wasBeyondThePointRef = import_react3.default.useRef(false);
  ...
  return /* @__PURE__ */ import_react3.default.createElement(Content, {
    "vaul-drawer": "",
...
function NestedRoot({ onDrag, onOpenChange, ...rest }) {
  ...
  return /* @__PURE__ */ import_react3.default.createElement(Root2, {
    nested: true,
    onClose: () => {
...
var DrawerOverlay = React24.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
  Drawer.Overlay,
  {
    ref,
...
var DrawerContent = React24.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(DrawerPortal, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
  Drawer.Content,
  {
    ref,
    className: cn(
...
var DrawerTitle = React24.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
  Drawer.Title,
  {
    ref,
    className: cn(
...
var DrawerDescription = React24.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
  Drawer.Description,
  {
    ref,
...
// node_modules/.pnpm/react-icons@5.3.0_react@18.3.1/node_modules/react-icons/tb/index.mjs
function TbCaretDownFilled(props) {
...
function TbTextWrapColumn(props) {
...
var Select = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(Root22, { ...popperScope, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
    SelectProvider,
    {
      ...
      disabled,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(Collection.Provider, { scope: __scopeSelect, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
  ...
  (props, forwardedRef) => {
    ...
    if (!context.open) {
      ...
      return frag ? ReactDOM5.createPortal(
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(SelectContentProvider, { scope: props.__scopeSelect, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(Collection.Slot, { scope: props.__scopeSelect, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { children: props.children }) }) }),
        frag
      ) : null;
    }
...
var SelectViewport = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(Collection.Slot, { scope: __scopeSelect, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
        Primitive.div,
        {
...
var BubbleSelect = React35.forwardRef(
  (props, forwardedRef) => {
...
var SelectTrigger2 = React36.forwardRef(({ className, children, showChevron = true, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
  Trigger2,
  {
    ref,
    className: cn(
    ...
    children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(import_jsx_dev_runtime2.Fragment, { children: [
      children,
      showChevron && /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Icon, { asChild: true, children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(ChevronDown, { className: "h-4 w-4" }, void 0, false, {
...
var SelectScrollUpButton2 = React36.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
  ScrollUpButton,
  {
    ref,
    className: cn(
    ...
    ...props,
    children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(ChevronUp, { className: "h-4 w-4" }, void 0, false, {
      fileName: "@/components/ui/select.tsx",
      lineNumber: 75,
      columnNumber: 5
    }, this)
...
var SelectScrollDownButton2 = React36.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
  ScrollDownButton,
  {
    ref,
    className: cn(
    ...
    ...props,
    children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(ChevronDown, { className: "h-4 w-4" }, void 0, false, {
      fileName: "@/components/ui/select.tsx",
      lineNumber: 92,
      columnNumber: 5
    }, this)
...
var SelectContent2 = React36.forwardRef(({ className, children, position = "popper", ...props }, ref) => /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Portal3, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
  Content22,
  {
    ref,
    className: cn(
    ...
    ...props,
    children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(SelectScrollUpButton2, {}, void 0, false, {
        fileName: "@/components/ui/select.tsx",
        lineNumber: 114,
        columnNumber: 7
      }, this),
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(SelectScrollDownButton2, {}, void 0, false, {
        fileName: "@/components/ui/select.tsx",
        lineNumber: 124,
        columnNumber: 7
      }, this)
...
var SelectLabel2 = React36.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
  Label,
  {
    ref,
...
var SelectItem2 = React36.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
  Item,
  {
    ref,
    className: cn(
    ...
    ...props,
    children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("span", { className: "absolute left-2 flex h-3.5 w-3.5 items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(ItemIndicator, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Check, { className: "h-4 w-4" }, void 0, false, {
        fileName: "@/components/ui/select.tsx",
        lineNumber: 156,
        columnNumber: 9
      }, this) }, void 0, false, {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(ItemText, { children }, void 0, false, {
        fileName: "@/components/ui/select.tsx",
        lineNumber: 160,
        columnNumber: 5
      }, this)
...
var SelectSeparator2 = React36.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
  Separator,
  {
    ref,
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
          Content3,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(VisuallyHiddenContentContextProvider, { scope: __scopeTooltip, isInside: true, children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Root4, { id: context.contentId, role: "tooltip", children: ariaLabel || children }) })
            ]
          }
        )
      }
...
var TooltipContent2 = React38.forwardRef(({ className, sideOffset = 4, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(
  Content23,
  {
    ref,
    sideOffset,
...
function ThemeToggle() {
  ...
  const options = [
    {
      value: "light",
      icon: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Sun, { size: 16 }, void 0, false, {
    ...
    {
      value: "dark",
      icon: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Moon, { size: 16 }, void 0, false, {
        fileName: "@/components/ThemeToggle.tsx",
        lineNumber: 27,
        columnNumber: 13
      }, this)
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(
    Select2,
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(TooltipProvider2, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Tooltip2, { children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(TooltipTrigger2, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(SelectTrigger2, { className: "w-auto", showChevron: false, children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(SelectValue2, { children: options.find((option) => option.value === currentTheme)?.icon }, void 0, false, {
            fileName: "@/components/ThemeToggle.tsx",
            lineNumber: 44,
            columnNumber: 15
          }, this) }, void 0, false, {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(TooltipContent2, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("p", { className: "text-xs", children: "Change dark mode" }, void 0, false, {
            fileName: "@/components/ThemeToggle.tsx",
            lineNumber: 50,
            columnNumber: 13
          }, this) }, void 0, false, {
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(SelectContent2, { children: options.map((themeOption) => /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(SelectItem2, { value: themeOption.value, children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "flex space-x-2 items-center", children: [
          themeOption.icon,
          /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("p", { children: themeOption.value }, void 0, false, {
            fileName: "@/components/ThemeToggle.tsx",
            lineNumber: 59,
            columnNumber: 15
          }, this)
...
var NavigationContent = () => {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "flex flex-col h-full gap-4 px-2", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "flex items-center justify-between px-2", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Link, { to: "/spreadsheet", className: "font-bold flex space-x-2 items-center", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("p", { className: cn("text-black dark:text-white rounded-md font-mono"), children: "neosheets" }, void 0, false, {
      fileName: "@/components/SideNavigation.tsx",
      lineNumber: 29,
      columnNumber: 11
    }, this) }, void 0, false, {
      fileName: "@/components/SideNavigation.tsx",
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("nav", { className: "flex-1", children: [
          ...
          children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(
            Link,
            {
              ...
              className: cn(
                ...
                "text-left",
                isActive("/spreadsheet") ? "font-semibold" : "text-stone-800 dark:text-stone-200"
              ),
              children: [
                /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(
                  Table2,
                  {
                    size: 16,
                    className: isActive("/spreadsheet") ? "text-primary" : "text-stone-600 dark:text-stone-400"
                  },
                  void 0,
                  false,
                  {
                ...
                /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("p", { children: "Spreadsheets" }, void 0, false, {
                  fileName: "@/components/SideNavigation.tsx",
                  lineNumber: 58,
                  columnNumber: 13
                }, this)
          ...
          children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(
            Link,
            {
              ...
              className: cn(
                "w-full flex space-x-2 items-center",
                "text-left",
                isActive("/function") ? "font-semibold" : "text-stone-800 dark:text-stone-200"
              ),
              children: [
                /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(
                  TbLambda,
                  {
                    size: 16,
                    className: isActive("/function") ? "text-primary" : "text-stone-600 dark:text-stone-400"
                  },
                  void 0,
                  false,
                  {
                ...
                /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("p", { children: "Function" }, void 0, false, {
                  fileName: "@/components/SideNavigation.tsx",
                  lineNumber: 84,
                  columnNumber: 13
                }, this)
          ...
          children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(
            Link,
            {
              ...
              className: cn(
                "w-full flex space-x-2 items-center",
                "text-left",
                isActive("/secrets") ? "font-semibold" : "text-stone-800 dark:text-stone-200"
              ),
              children: [
                /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(
                  KeyRound,
                  {
                    size: 16,
                    className: isActive("/secrets") ? "text-primary" : "text-stone-600 dark:text-stone-400"
                  },
                  void 0,
                  false,
                  {
                ...
                /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("p", { children: "Secrets" }, void 0, false, {
                  fileName: "@/components/SideNavigation.tsx",
                  lineNumber: 110,
                  columnNumber: 13
                }, this)
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "flex gap-2 items-center justify-between px-2 pb-4", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Button, { variant: "icon", className: "p-0 px-1.5 py-1.5 h-8", asChild: true, children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(
        Link,
        {
          to: "https://github.com/suhjohn/prompt-playground",
          target: "_blank",
          rel: "noreferrer",
          children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(IoLogoGithub, { size: 20 }, void 0, false, {
            fileName: "@/components/SideNavigation.tsx",
            lineNumber: 121,
            columnNumber: 13
          }, this)
...
var DrawerNavigation = ({
  ...
  Drawer2,
  {
    ...
    children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(DrawerContent, { className: "h-[100dvh] w-60 z-[1000]", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(DrawerTitle, {}, void 0, false, {
        fileName: "@/components/SideNavigation.tsx",
        lineNumber: 145,
        columnNumber: 7
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(DrawerDescription, {}, void 0, false, {
        fileName: "@/components/SideNavigation.tsx",
        lineNumber: 146,
        columnNumber: 7
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "w-full flex items-center p-2", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(
        Button,
        {
          onClick: () => onClose(),
          variant: "icon",
          className: "p-0 w-auto",
          children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(PanelLeft, { size: 16 }, void 0, false, {
            fileName: "@/components/SideNavigation.tsx",
            lineNumber: 153,
            columnNumber: 11
          }, this)
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(NavigationContent, {}, void 0, false, {
        fileName: "@/components/SideNavigation.tsx",
        lineNumber: 156,
        columnNumber: 7
      }, this)
...
var OpenNavigation = () => /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "hidden lg:block h-screen text-stone-200 flex-shrink-0 pt-4 w-60 dark:bg-black border-r border-r-stone-200 dark:border-r-stone-800", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(NavigationContent, {}, void 0, false, {
  fileName: "@/components/SideNavigation.tsx",
  lineNumber: 163,
  columnNumber: 5
}, this) }, void 0, false, {
...
var ClosedNavigation = () => {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("nav", { className: "flex flex-col items-center gap-4", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "flex items-center justify-between px-2", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Link, { to: "/spreadsheet", className: "font-bold flex space-x-2 items-center", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(
            "p",
            {
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "flex flex-col gap-2 items-center justify-between pb-4", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Button, { variant: "icon", className: "p-0 px-1.5 py-1.5 h-8", asChild: true, children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(
            Link,
            {
              to: "https://github.com/suhjohn/prompt-playground",
...
var localForageInstance = import_localforage.default.createInstance({
  name: "NeoSheetsStore",
  version: 1,
  storeName: "db",
...
localforage/dist/localforage.js:
  ...
  *)
*/
//# sourceMappingURL=/build/_shared/chunk-QLLD56SL.js.map
